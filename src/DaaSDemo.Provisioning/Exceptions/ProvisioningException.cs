...
namespace DaaSDemo.Provisioning.Exceptions
{
        ...
        : ProvisioningException
    {
        ...
        /// </param>
        public SqlExecutionException(string message, int serverId, int databaseId, IEnumerable<string> sqlMessages, IEnumerable<SqlError> sqlErrors)
            : base(message)
        {
            if (sqlMessages == null)
        ...
        ///     An <see cref="SqlError"/> list representing the error(s) that occurred.
        /// </param>
        public SqlExecutionException(string message, Exception innerException, int serverId, int databaseId, IEnumerable<string> sqlMessages, IEnumerable<SqlError> sqlErrors)
            : base(message, innerException)
        {
            if (sqlMessages == null)
                throw new ArgumentNullException(nameof(sqlMessages));
