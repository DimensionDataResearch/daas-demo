...
namespace DaaSDemo.Provisioning.Actors
{
    ...
    /// <summary>
    ///     Actor that publishes events relating to Kubernetes Pods in the default namespace.
    /// </summary>
        ...
        : ReceiveActorEx
    {
        ...
        /// <summary>
        ///     Create a new <see cref="PodEvents"/> actor.
        /// </summary>
        /// <param name="kubeClient">
        ///     The <see cref="KubeApiClient"/> used to communicate with the Kubernetes API.
        /// </param>
        public PodEvents(KubeApiClient kubeClient)
        {
            if (kubeClient == null)
                throw new ArgumentNullException(nameof(kubeClient));
            
            KubeClient = kubeClient;
            EventSource = KubeClient.PodsV1.WatchAll(
                kubeNamespace: "default"
            );

            Receive<V1ResourceEvent<V1Pod>>(resourceEvent =>
            {
        ...
        /// </summary>
        IObservable<V1ResourceEvent<V1Pod>> EventSource { get; }
            ...
            : ResourceEventBus<V1Pod>
        {
            ...
            /// </returns>
            protected override V1ObjectMeta GetMetadata(V1Pod resource)
            {
                if (resource == null)
