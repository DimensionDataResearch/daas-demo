...
namespace DaaSDemo.KubeClient.Models
{
    ...
    public class NodeStatusV1
    {
        ...
        public List<NodeAddressV1> Addresses { get; set; }
        ...
        public List<NodeConditionV1> Conditions { get; set; }
        ...
        /// </summary>
        [JsonProperty("images")]
        public List<ContainerImageV1> Images { get; set; }
        ...
        public List<AttachedVolumeV1> VolumesAttached { get; set; }
    }
}
