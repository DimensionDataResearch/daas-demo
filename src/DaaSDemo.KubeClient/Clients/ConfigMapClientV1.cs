...
namespace DaaSDemo.KubeClient.Clients
{
        ...
        : KubeResourceClient
    {
        ...
        static class Requests
        {
            ...
            /// </summary>
            public static readonly HttpRequest Collection = HttpRequest.Factory.Json("api/v1/namespaces/{Namespace}/configmaps?labelSelector={LabelSelector?}");

            /// <summary>
            ///     A get-by-name ConfigMap (v1) request.
            /// </summary>
            public static readonly HttpRequest ByName = HttpRequest.Factory.Json("api/v1/namespaces/{Namespace}/configmaps/{Name}");
        }
    }
}